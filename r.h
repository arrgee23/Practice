 ...
 */ 
#undef PRNDEF_SUPPORT_MANUAL_FEEDER_TRAY
 ...
 */ 
#undef PRNDEF_MISMATCH_PAPER_PROPERTY_USING_PCB
 ...
 */ 
#undef PRNDEF_OMIT_BAND_FOR_SHORT_PAGE_INTERVAL

/** 
 * @brief To operate motor idling for seperated toner type.
 */ 
#undef PRNDEF_SUPPORT_INIT_MOTOR_OPERATION
 ...
 */ 
#undef PRNDEF_SUPPORT_SEPARATED_TYPE
 ...
 */ 
#undef PRNDEF_SUPPORT_IMGUNIT_STOP_ALERT_REPORT
 ...
 */ 
#define PRNDEF_SUPPORT_ENGINE_STACKING
 ...
 */ 
#define PRNDEF_MARGIN_CTS

/** 
 * @brief To get target value of crum from FW not crum.
 */ 
#define PRNDEF_CRU_TARGET_VALUE_FROM_FW

/** 
 * @brief To support tray confrim(by UI)
 */ 
#define PRNDEF_SUPPORT_TRAY_CONFIRM_BY_UI

/** 
 * @brief RTC is supported.
 */ 
#define PRNDEF_SUPPORT_ELAPSEDTIME_FOR_RTC

/** 
 * @brief For A3 machine
 */ 
#define PRNDEF_A3_MACHINE

/** 
 * @brief To support upgrading F/W of trays.
 */ 
#define PRNDEF_OPTIONAL_TRAYS_FW_UPGRADE
 ...
 */ 
#define PRNDEF_SUPPORT_ENGINE_DATA_BACKUP
 ...
 */ 
#define PRNDEF_SUPPORT_MISMATCH_FOR_DIFF_EDGEFEED
 ...
 */ 
#define FR_PRN_XEROX_SUPPLY_STRATEGY
 ...
 * @brief 
 */ 
#define PRNDEF_NOTSUPPORT_CRU_HARDSTOP

/** 
 * @brief 
 */ 
#define FR_PRN_NOT_SUPPORT_CRU_SUPPLYINDEX

/** 
 * @brief 
 */ 
#define FR_PRN_SUPPORT_TONER_SENSING
 ...
 * @brief 
 */ 
#define FR_PRN_XEROX_BYPASS_MODE
 ...
 */ 
#define FR_PRN_SUPPORT_ENG_LOG_BACKUP
